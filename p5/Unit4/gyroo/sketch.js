...
function setup() {
  ...
  bunnyImage = loadImage("assets/nigel.jpg");
  f = loadFont("assets/type.otf");
  imageMode(CENTER);
  rectMode(CENTER);
...
function draw() {
  ...
  background(91, 53, 30); // light blue
  ...
  textSize(100);
  textAlign(CENTER);
  text("Winter Nigel", width / 2, height / 2 - 200);
